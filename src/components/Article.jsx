                ...
                ?<div id='layout'>
                    <main className="article_view">
                        ...
                        <div id='footer'>
                            {click && like === 1
                                ?<div>
                                    <button className="like1" disabled onClick ={()=>voteHandler(1)}> 
                                        <img className="icon" src= {Like} alt='like icon'/> 
                                        <p>{article.votes}</p> 
                                    </button>
                                    <button className="like2" onClick ={()=>voteHandler(-1)}> 
                                        <img className="icon" src= {dislike} alt='dislike icon'/>
                                        <p>Unlike</p> 
                                    </button>
                                </div> 
                            
                            :click && like === -1
                                ?<button className="like3"  onClick ={()=>voteHandler(1)}>
                                    <img className="icon" src= {dislike} alt='dislike icon'/> 
                                    <p>Remove Dislike</p> 
                                </button>
                                :<div>
                                    <button className="like1" onClick ={()=>voteHandler(1)}> 
                                        <img className="icon" src= {Like} alt='like icon'/> 
                                        <p>{article.votes}</p> 
                                    </button>
                                    <button className="like2" onClick ={()=>voteHandler(-1)}>
